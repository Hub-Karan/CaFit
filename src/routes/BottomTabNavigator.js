...
import MyProfile from '../screens/my-profile-screens/MyProfile';
import ProfileFitnessLevel from '../screens/my-profile-screens/ProfileFItnessLevel';
...
const BottomTabNavigator = (props) => {
    ...
    return (
        ...
        >
            ...
            />
            <Tab.Screen
                name="ProfileFitnessLevel"
                component={ProfileFitnessLevel}
                options={{
                    title: 'My Fitness Level',
                    headerTitleAlign: 'center',
                    headerShadowVisible: false,
                    headerLeft: () => {
                        return <HeaderLeft fill={color.secondaryColor} />;
